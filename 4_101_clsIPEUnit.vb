...
Public Class IPE_clsUnit
    ...
    Private mUserLeakage As String
...
#Region "LENGTH CONVERSIONS ROUTINES:"
    ...
    Public Function L_UserToCon(ByVal strData As String) As Double
        '=========================================================
    ...
    Public Function L_UserToCon(ByVal sngData As Double) As Double
        '=========================================================
        '....This utility function converts a length data string from user 
        '........to consistent unit and returns the corresponding value.
